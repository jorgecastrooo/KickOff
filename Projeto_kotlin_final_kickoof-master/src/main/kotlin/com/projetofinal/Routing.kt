    ...
    fun Application.configureRouting() {
        routing {
            ...
            post("/register") {
                ...
                // Verificação: Nacionalidade existente na bd
                ...
                // Verificação Username ou e-mail já existe
            ...
            post("/delete-user") {
                ...
                try {
                    println("Deletando usuário: $username")
                    transaction {
                        exec(
                            """
            ...
            post("/toggle_admin") {
                try {
                    ...
                    println("Parâmetros recebidos: $parameters")

                    val username = parameters["username"]

                    if (username == null) {

                        println("Erro: username não foi enviado.")
                        call.respond(HttpStatusCode.BadRequest, "Parâmetros inválidos")
                        return@post
                    }

                    try {
                        println("Tentando executar a query para o username: $username")
            ...
            get("/liga") {
                ...
                try {
                    ...
                    println("Erro ao consultar a tabela 'liga': ${e.message}")
                    e.printStackTrace()
                    ...
                    val games = transaction {
                        Jogo
                            ...
                            .map { jogoRow ->
                                ...
                                // Contando os autogols e atualiza as equipas
                                ...
                                // Obter os jogadores que marcaram gols para cada equipa
                                ...
                                // Construção de  string para cada jogo
                                "Jogo: $jogoId\n" +
                                        "Hora: $hora\n" +
                                        "Estado: $estado\n" +
                ...
                try {
                    ...
                    val jogosDoDia = transaction {
                        try {
                            ...
                            val jogos = Jogo
                                .select { Jogo.data_ eq date } // Usar java.sql.Date para comparar apenas a data
                                .map { jogo ->
